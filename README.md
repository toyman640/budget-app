...
The **Budget App**  is an application that helps the user keep record of financial transactions of various types/categories.
...
```sh
  cd my-folder
  git clone git@github.com:toyman640/budget-app.git
  bundle install
```
...
Deployment: [Kowope](https://kowope.onrender.com/)
...
Feel free to check the [issues page](https://github.com/toyman640/budget-app/issues).
